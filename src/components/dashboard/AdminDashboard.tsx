...
const AdminDashboard = ({ user }: AdminDashboardProps) => {
  ...
  const menuItems = [
    ...
    { id: "assigned-companies", label: "Assigned", icon: Building2 },
    { id: "unassigned-companies", label: "Unassigned", icon: Building2 },
  ...
  return (
    ...
    >
      ...
      {currentView === "assigned-companies" && <AllCompaniesView userRole="admin" filterType="assigned" />}
      {currentView === "unassigned-companies" && <AllCompaniesView userRole="admin" filterType="unassigned" />}
